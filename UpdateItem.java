...
public class UpdateItem extends Application
{
	...
	private void addControls(GridPane gridPane)
	{
		...
		Label headerLabel = new Label("Update Menu Item");
        ...
        Label update = new Label("Enter Item Name, Section, and Fields that Need Updating");
        ...
        submitButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                //LOOP THROUGH MENU ARRAYLIST AND UPDATE ITEM USING SET METHODS
                ...
                for(int i = 0; i < menuList.size(); i++)
                {
                	...
                	if(name.equals(nameField.getText()))
                	{
                		if(section.equals(sectionField.getText()))
                		{
                			...
                			{
                				menuList.get(i).setIngredients(ingredientsField.getText());
                			}
                            if(!imageField.getText().isEmpty())
                            {
                            	Image image = new Image(imageField.getText());
                            	menuList.get(i).setImage(image); 
                            }
                		}
                	}
                	else
                ...
                showAlert(Alert.AlertType.CONFIRMATION, gridPane.getScene().getWindow(), "Item Updated Successfully!", "");
            }
        });
    }
